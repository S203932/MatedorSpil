...
public class FieldList {
    ...
    public void setupField(String filename){
        ...
        ((Neutral)fieldList[0]).setPosition(1);
        ...
        ((Tax5)fieldList[4]).setPosition(5);
        ((Tax5)fieldList[4]).setName(stringArrayList.get(5));

        fieldList[5] = new Ferry();
        ((Ferry)fieldList[5]).setPosition(6);
        ...
        ((Chance)fieldList[7]).setPosition(8);
        ...
        ((Neutral)fieldList[10]).setPosition(11);
        ...
        ((Brewery)fieldList[12]).setPosition(13);
        ...
        ((Ferry)fieldList[15]).setPosition(16);
        ...
        ((Chance)fieldList[17]).setPosition(18);
        ...
        ((Neutral)fieldList[20]).setPosition(21);
        ...
        ((Chance)fieldList[22]).setPosition(23);
        ...
        ((Ferry)fieldList[25]).setPosition(26);
        ...
        ((Brewery)fieldList[28]).setPosition(29);
        ...
        ((GoJail)fieldList[30]).setPosition(31);
        ...
        ((Chance)fieldList[33]).setPosition(34);
        ...
        ((Ferry)fieldList[35]).setPosition(36);
        ...
        ((Chance)fieldList[36]).setPosition(37);
        ...
        ((Tax39)fieldList[38]).setPosition(39);
        ((Tax39)fieldList[38]).setName(stringArrayList.get(39));
