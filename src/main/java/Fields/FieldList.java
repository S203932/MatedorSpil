...
public class FieldList {
    ...
    public void setupField(String filename) {
        ...
        fieldList[0].setPosition(1);
        fieldList[0].setName(stringArrayList.get(1));
        fieldList[0].setColor(Color.LIGHT_GRAY);

        fieldList[1] = new RealEstate();
        fieldList[1].setPosition(2);
        ((RealEstate) fieldList[1]).setUpgrade(0);
        ((RealEstate) fieldList[1]).setUpgradeValue(1000);
        fieldList[1].setName(stringArrayList.get(2));
        ((RealEstate) fieldList[1]).setPrice(1200);
        fieldList[1].setColor(Color.BLUE);
        ...
        fieldList[2].setPosition(3);
        fieldList[2].setName(stringArrayList.get(3));
        fieldList[2].setColor(Color.BLACK);

        fieldList[3] = new RealEstate();
        fieldList[3].setPosition(4);
        ((RealEstate) fieldList[3]).setUpgrade(0);
        ((RealEstate) fieldList[3]).setUpgradeValue(1000);
        fieldList[3].setName(stringArrayList.get(4));
        ((RealEstate) fieldList[3]).setPrice(1200);
        fieldList[3].setColor(Color.BLUE);
        ...
        fieldList[4].setPosition(5);
        fieldList[4].setName(stringArrayList.get(5));

        fieldList[5] = new Ferry();
        fieldList[5].setPosition(6);
        fieldList[5].setName(stringArrayList.get(6));
        ((Ferry) fieldList[5]).setPrice(4000);
        fieldList[5].setColor(Color.CYAN);

        fieldList[6] = new RealEstate();
        fieldList[6].setPosition(7);
        ((RealEstate) fieldList[6]).setUpgrade(0);
        ((RealEstate) fieldList[6]).setUpgradeValue(1000);
        fieldList[6].setName(stringArrayList.get(7));
        ((RealEstate) fieldList[6]).setPrice(2000);
        fieldList[6].setColor(Color.ORANGE);
        ...
        fieldList[7].setPosition(8);
        fieldList[7].setName(stringArrayList.get(8));
        fieldList[7].setColor(Color.BLACK);

        fieldList[8] = new RealEstate();
        fieldList[8].setPosition(9);
        ((RealEstate) fieldList[8]).setUpgrade(0);
        ((RealEstate) fieldList[8]).setUpgradeValue(1000);
        fieldList[8].setName(stringArrayList.get(9));
        ((RealEstate) fieldList[8]).setPrice(2000);
        fieldList[8].setColor(Color.ORANGE);
        ...
        fieldList[10].setPosition(11);
        fieldList[10].setName(stringArrayList.get(11));
        fieldList[10].setColor(Color.LIGHT_GRAY);

        fieldList[11] = new RealEstate();
        fieldList[11].setPosition(12);
        ((RealEstate) fieldList[11]).setUpgrade(0);
        ((RealEstate) fieldList[11]).setUpgradeValue(2000);
        fieldList[11].setName(stringArrayList.get(12));
        ((RealEstate) fieldList[11]).setPrice(2800);
        fieldList[11].setColor(Color.GREEN);
        ...
        fieldList[12].setPosition(13);
        fieldList[12].setName(stringArrayList.get(13));
        ((Brewery) fieldList[12]).setPrice(3000);
        fieldList[12].setColor(Color.PINK);

        fieldList[13] = new RealEstate();
        fieldList[13].setPosition(14);
        ((RealEstate) fieldList[13]).setUpgrade(0);
        ((RealEstate) fieldList[13]).setUpgradeValue(2000);
        fieldList[13].setName(stringArrayList.get(14));
        ((RealEstate) fieldList[13]).setPrice(2800);
        fieldList[13].setColor(Color.GREEN);
        ...
        fieldList[15].setPosition(16);
        fieldList[15].setName(stringArrayList.get(16));
        ((Ferry) fieldList[15]).setPrice(4000);
        fieldList[15].setColor(Color.CYAN);

        fieldList[16] = new RealEstate();
        fieldList[16].setPosition(17);
        ((RealEstate) fieldList[16]).setUpgrade(0);
        ((RealEstate) fieldList[16]).setUpgradeValue(2000);
        fieldList[16].setName(stringArrayList.get(17));
        ((RealEstate) fieldList[16]).setPrice(3600);
        fieldList[16].setColor(Color.GRAY);
        ...
        fieldList[17].setPosition(18);
        fieldList[17].setName(stringArrayList.get(18));
        fieldList[17].setColor(Color.BLACK);

        fieldList[18] = new RealEstate();
        fieldList[18].setPosition(19);
        ((RealEstate) fieldList[18]).setUpgrade(0);
        ((RealEstate) fieldList[18]).setUpgradeValue(2000);
        fieldList[18].setName(stringArrayList.get(19));
        ((RealEstate) fieldList[18]).setPrice(3600);
        fieldList[18].setColor(Color.GRAY);
        ...
        fieldList[20].setPosition(21);
        fieldList[20].setName(stringArrayList.get(21));
        fieldList[20].setColor(Color.LIGHT_GRAY);

        fieldList[21] = new RealEstate();
        fieldList[21].setPosition(22);
        ((RealEstate) fieldList[21]).setUpgrade(0);
        ((RealEstate) fieldList[21]).setUpgradeValue(3000);
        fieldList[21].setName(stringArrayList.get(22));
        ((RealEstate) fieldList[21]).setPrice(4400);
        fieldList[21].setColor(Color.RED);
        ...
        fieldList[22].setPosition(23);
        fieldList[22].setName(stringArrayList.get(23));
        fieldList[22].setColor(Color.BLACK);

        fieldList[23] = new RealEstate();
        fieldList[23].setPosition(24);
        ((RealEstate) fieldList[23]).setUpgrade(0);
        ((RealEstate) fieldList[23]).setUpgradeValue(3000);
        fieldList[23].setName(stringArrayList.get(24));
        ((RealEstate) fieldList[23]).setPrice(4400);
        fieldList[23].setColor(Color.RED);
        ...
        fieldList[25].setPosition(26);
        fieldList[25].setName(stringArrayList.get(26));
        ((Ferry) fieldList[25]).setPrice(4000);
        fieldList[25].setColor(Color.CYAN);

        fieldList[26] = new RealEstate();
        fieldList[26].setPosition(27);
        ((RealEstate) fieldList[26]).setUpgrade(0);
        ((RealEstate) fieldList[26]).setUpgradeValue(3000);
        fieldList[26].setName(stringArrayList.get(27));
        ((RealEstate) fieldList[26]).setPrice(5200);
        fieldList[26].setColor(Color.WHITE);
        ...
        fieldList[28].setPosition(29);
        fieldList[28].setName(stringArrayList.get(29));
        ((Brewery) fieldList[28]).setPrice(3000);
        fieldList[28].setColor(Color.PINK);

        fieldList[29] = new RealEstate();
        fieldList[29].setPosition(30);
        ((RealEstate) fieldList[29]).setUpgrade(0);
        ((RealEstate) fieldList[29]).setUpgradeValue(3000);
        fieldList[29].setName(stringArrayList.get(30));
        ((RealEstate) fieldList[29]).setPrice(5600);
        fieldList[29].setColor(Color.WHITE);
        ...
        fieldList[30].setPosition(31);
        fieldList[30].setName(stringArrayList.get(31));
        fieldList[30].setColor(Color.DARK_GRAY);

        fieldList[31] = new RealEstate();
        fieldList[31].setPosition(32);
        ((RealEstate) fieldList[31]).setUpgrade(0);
        ((RealEstate) fieldList[31]).setUpgradeValue(4000);
        fieldList[31].setName(stringArrayList.get(32));
        ((RealEstate) fieldList[31]).setPrice(6000);
        fieldList[31].setColor(Color.YELLOW);
        ...
        fieldList[33].setPosition(34);
        fieldList[33].setName(stringArrayList.get(34));
        fieldList[33].setColor(Color.BLACK);

        fieldList[34] = new RealEstate();
        fieldList[34].setPosition(35);
        ((RealEstate) fieldList[34]).setUpgrade(0);
        ((RealEstate) fieldList[34]).setUpgradeValue(4000);
        fieldList[34].setName(stringArrayList.get(35));
        ((RealEstate) fieldList[34]).setPrice(6400);
        fieldList[34].setColor(Color.YELLOW);
        ...
        fieldList[35].setPosition(36);
        fieldList[35].setName(stringArrayList.get(36));
        ((Ferry) fieldList[35]).setPrice(4000);
        fieldList[35].setColor(Color.CYAN);

        fieldList[36] = new Chance();
        fieldList[36].setPosition(37);
        fieldList[36].setName(stringArrayList.get(37));
        fieldList[36].setColor(Color.BLACK);


        fieldList[37] = new RealEstate();
        fieldList[37].setPosition(38);
        ((RealEstate) fieldList[37]).setUpgrade(0);
        ((RealEstate) fieldList[37]).setUpgradeValue(4000);
        fieldList[37].setName(stringArrayList.get(38));
        ((RealEstate) fieldList[37]).setPrice(7000);
        fieldList[37].setColor(Color.MAGENTA);
        ...
        fieldList[38].setPosition(39);
        fieldList[38].setName(stringArrayList.get(39));

        fieldList[39] = new RealEstate();
        fieldList[39].setPosition(40);
        ((RealEstate) fieldList[39]).setUpgrade(0);
        ((RealEstate) fieldList[39]).setUpgradeValue(4000);
        fieldList[39].setName(stringArrayList.get(40));
        ((RealEstate) fieldList[39]).setPrice(8000);
        fieldList[39].setColor(Color.MAGENTA);
